 ...
 * Reconfigure a basin.
 */
export function basinsReconfigureBasin(
  client: S2Core,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ReconfigureBasinRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.BasinReconfiguration, {
    explode: true,
  });
