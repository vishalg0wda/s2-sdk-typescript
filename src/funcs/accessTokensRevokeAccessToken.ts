 ...
 */
export function accessTokensRevokeAccessToken(
  client: S2Core,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RevokeAccessTokenRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/access-tokens/{id}")(pathParams);
